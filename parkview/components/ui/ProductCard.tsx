import {StyleProp, StyleSheet, Text, TouchableOpacity, View, ViewStyle, Image, Alert } from 'react-native'
...
const ProductCard: React.FC<ProductCardProps> = ({
  ...
  return (
    ...
    style={[styles.card, compact && styles.compactCard, customStyle]} activeOpacity={0.8}>
